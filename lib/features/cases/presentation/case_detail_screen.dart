            ...
            children: [
              _Section(
                ...
                children: [
                  ...
                  _Row('Visit type', caseModel.visitType.replaceAll('_', ' ')),
                  _Row('OASIS case', caseModel.isOasisCase ? 'Yes' : 'No'),
                  if (caseModel.specialties.isNotEmpty)
                    _Row('Specialties', caseModel.specialties.join(', ')),
                  _Row(
                    'Status',
                  ...
                  _Row('Created', df.format(caseModel.createdAt)),
                ],
              ),
              ...
              _Section(
                ...
                children: [
                  ...
                  _Row('City / State', '${caseModel.city}, ${caseModel.state}'),
              ...
              if (caseModel.primaryDiagnosis != null) ...[
                ...
                _Section(
                  title: 'Clinical',
                  children: [
                    _Row('Diagnosis', caseModel.primaryDiagnosis!),
          ...
          Expanded(
            child: Column(
              ...
              children: [
                ...
                Text(
                  tf.format(shift.scheduledStart),
                  style: const TextStyle(
                    fontSize: 11,
                    color: Color(0xFF94A3B4),
                  ),
